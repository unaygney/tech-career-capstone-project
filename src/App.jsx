...
function App() {
  return (
    <Routes>
      ...
      <Route path="/theater/event/:id" element={<DetailEvent />} />
      <Route path="/cinema/event/:id" element={<DetailEvent />} />
      <Route path="/exhibit/event/:id" element={<DetailEvent />} />
      <Route path="/concert/event/:id" element={<DetailEvent />} />
      <Route path="/*" element={<HomePage />} />
